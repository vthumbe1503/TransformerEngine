...
class TestActivation:
    def ref_act(self, x, activation_type, **act_params):
        return _jax_act_lu(x, activation_type, **act_params).data
    ...
    def test_act_grad(self, shape, activation_type):
        ...
        value_n_grad_primitive_func = jit(
            value_and_grad(self.primitive_func, (0,)), static_argnums=(1,), static_argnames="limit"
        )
        act_params = {"limit":7.0} if activation_type == ("oss_silu","clamped_linear") else {}

...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  ...
  m.def("dequantize", &transformer_engine::pytorch::dequantize, "Dequantize", py::arg("input"),
        py::arg("otype"));
  m.def("quantize_grouped", transformer_engine::pytorch::quantize_grouped, py::arg("input"),
        py::arg("output"));
  m.def("quantize_grouped_current_scaling",
        transformer_engine::pytorch::quantize_grouped_current_scaling, py::arg("input"),
        py::arg("output"), py::arg("noop") = py::none());

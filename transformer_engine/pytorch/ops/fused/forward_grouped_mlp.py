    ...
    def fuser_forward(
        ...
        *,
        ...
        if requires_grad:
            ...
            # Backward only consumes columnwise data/scales for wgrad, so we
            # drop the rowwise tiles to save memory. NVFP4 amax tensors live on
            # the GroupedTensor itself and are preserved.
